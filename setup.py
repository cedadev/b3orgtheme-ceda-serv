...
try:
    import b3orgtheme-ceda-serv.__version__ as version
except ImportError:
...
if __name__ == "__main__":
    ...
    setup(
        name = 'b3orgtheme-ceda-serv',
        version = version,
        description = 'Static theme using bootstrap 3, CEDA Services branding',
        ...
        url = 'https://github.com/cedadev/b3orgtheme-ceda-serv',
